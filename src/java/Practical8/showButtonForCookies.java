 ...
 */
public class showButtonForCookies extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet showButtonForCookies</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<a href='showCookies'> Show Cookies </a>");
            out.println("</body>");
            out.println("</html>");
        }
    }
